...
const Favoris = require('./favoris.js')(sequelize, require('sequelize').DataTypes)



const models = { categories, User, SousCategorie, Produit, PhotoProduit, Follower, Panier, Favoris};
